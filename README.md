...
- Classification experiments with the Vertebral Column dataset
- MNIST linear-learner workflow
- Notebook-first material for applied machine-learning study
...
Coleção acadêmica de notebooks Jupyter para fundamentos de Python e aprendizado de máquina aplicado, incluindo o dataset Vertebral Column e um fluxo de linear learner com MNIST orientado à AWS.
